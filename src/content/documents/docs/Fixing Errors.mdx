...
-   <span style="color:yellow; -webkit-text-stroke: .25px black; text-stroke;">
        Error Message:{" "}
    </span> What is the error
-   <span style="color: White; -webkit-text-stroke: .25px black; text-stroke;">Environment: </span> is
    the error on the server, client, or studio
