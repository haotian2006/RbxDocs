...
var mdimg = function (_a) {
    return __awaiter(void 0, [_a], void 0, function (_b) {
        var _outputFileTypes,
            _encodingTypes,
            _result,
            _input,
            _inputFilename,
            ...
            _outputBase64String;
        var _d;
        var inputText = _b.inputText,
            inputFilename = _b.inputFilename,
            mdText = _b.mdText,
            mdFile = _b.mdFile,
            outputFilename = _b.outputFilename,
            _e = _b.type,
            type = _e === void 0 ? "png" : _e,
            _f = _b.width,
            width = _f === void 0 ? 800 : _f,
            _g = _b.height,
            height = _g === void 0 ? 600 : _g,
            _h = _b.encoding,
            encoding = _h === void 0 ? "binary" : _h,
            _j = _b.quality,
            quality = _j === void 0 ? 100 : _j,
            htmlText = _b.htmlText,
            cssText = _b.cssText,
            _k = _b.htmlTemplate,
            htmlTemplate = _k === void 0 ? "default" : _k,
            _l = _b.cssTemplate,
            cssTemplate = _l === void 0 ? "default" : _l,
            _m = _b.log,
            log = _m === void 0 ? false : _m,
            _o = _b.puppeteerProps,
            puppeteerProps = _o === void 0 ? {} : _o;
        return __generator(this, function (_p) {
            switch (_p.label) {
                case 0:
                    ...
                    if (_inputFilename) {
                        ...
                        if ((0, fs_1.existsSync)(_inputFilePath)) {
                            if ((0, fs_1.statSync)(_inputFilePath).isFile()) {
                                ...
                                if (log) {
                                    process.stderr.write(
                                        "Info: start to convert file ".concat(
                                            _inputFilePath,
                                            " to an image...\n",
                                        ),
                                    );
                            ...
                            throw new Error(
                                "Error: input file ".concat(_inputFilePath, " is not exists.\n"),
                            );
                        }
                    } else if (_inputText) {
                        _input = _inputText;
                    ...
                    if (!_encodingTypes.includes(_encoding)) {
                        ...
                        throw new Error(
                            "Error: encoding type "
                                .concat(_encoding, " is not supported. Valid types: ")
                                .concat(_encodingTypes.join(", "), ".\n"),
                        );
                    }
                    _type = type;
                    if (!_outputFileTypes.includes(_type)) {
                        ...
                        throw new Error(
                            "Error: output file type "
                                .concat(_type, " is not supported. Valid types: ")
                                .concat(_outputFileTypes.join(", "), ".\n"),
                        );
                    }
                    _output = "";
                    if (_saveToDisk) {
                        if (outputFilename) {
                            ...
                            if (_outputFilenameArrLength <= 1) {
                                ...
                                _output = (0, path_1.resolve)(
                                    _outputFilePath,
                                    "".concat(_outputFilename, ".").concat(_type),
                                );
                            } else {
                                ...
                                if (_outputFileTypes.includes(_outputFileType)) {
                                    ...
                                    if (log) {
                                        process.stderr.write(
                                            "Warning: output file type must be one of 'jpeg', 'png' or 'webp'. Use '".concat(
                                                _type,
                                                "' type.\n",
                                            ),
                                        );
                ...
                case 1:
                    _html = _c.apply(void 0, [
                        ((_d.inputHtml = _p.sent()),
                ...
                case 6:
                    ...
                    if (log) {
                        process.stderr.write(
                            "Info: convert to image".concat(
                                _saveToDisk ? " and saved as ".concat(_output) : "",
                                " successfully!\n",
                            ),
                        );
                    }
...
function _createEmptyFile(filename) {
    ...
    try {
        ...
        throw new Error(
            "Error: create new file ".concat(filename, " failed.\n").concat(String(error), "\n"),
        );
    }
}
function _generateImageFilename(type) {
    var _now = new Date();
    var _outputFilenameSuffix = ""
        .concat(_now.getFullYear(), "_")
        .concat(_now.getMonth() + 1, "_")
        .concat(_now.getDate(), "_")
        .concat(_now.getHours(), "_")
        .concat(_now.getMinutes(), "_")
        .concat(_now.getSeconds(), "_")
        .concat(_now.getMilliseconds());
